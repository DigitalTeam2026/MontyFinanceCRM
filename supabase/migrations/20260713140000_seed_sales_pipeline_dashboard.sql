...
BEGIN
  ...
  ('5a1e0000-0000-4000-a000-000000000002', v_page, v_dash, 'funnel_stage', 'Pipeline Overview',
   ...
   '{}'::jsonb,
   $j${"stages":[{"id":"stage_prospects","label":"Prospects","entity":"crm_prospect","measure":"count","color":"#4f6df5","icon":"Users","totalLabel":"Prospects","displayMode":"breakdown","breakdownField":"status_reason","breakdownValues":["Active","In Progress","Converted to Lead","Inactive"],"conversionValue":"Converted to Lead","showPercentages":true,"showProgressBars":true,"colorByValue":{"1":"#4f6df5","3":"#e08a2b","2":"#9aa0b4","7":"#8b5cf6"}},{"id":"stage_leads","label":"Leads","entity":"lead","measure":"count","color":"#8b5cf6","icon":"UserPlus","totalLabel":"Leads","displayMode":"breakdown","breakdownField":"status_reason","breakdownValues":["New","Qualified","Lost"],"conversionValue":"Qualified","showPercentages":true,"showProgressBars":true,"colorByValue":{"1":"#4f6df5","4":"#17a673","5":"#e35d5d"}},{"id":"stage_opps","label":"Opportunities","entity":"opportunity","measure":"count","color":"#12b3a6","icon":"Target","totalLabel":"Opportunities","displayMode":"breakdown","breakdownField":"status_reason","breakdownValues":["In Progress","Won","Canceled"],"showPercentages":true,"showProgressBars":true,"colorByValue":{"1":"#e08a2b","3":"#17a673","4":"#e35d5d"}}]}$j$::jsonb,
   $j${"showHeader":true,"funnelLayout":"horizontal","showArrows":true,"showConversion":true,"conversionDecimals":0,"showStageSubtitle":false,"scrollStages":true,"fitStages":true,"stageGap":8,"numberFormat":"number","arrowColor":"#4f6df5","background":"#ffffff","borderColor":"#e9eaf0","borderRadius":18,"titleColor":"#171a29","valueColor":"#171a29","breakdownTrackColor":"#eef0f6","fontFamily":"'Space Grotesk', 'IBM Plex Sans', sans-serif"}$j$::jsonb,
   '{}'::jsonb, '{}'::jsonb),
