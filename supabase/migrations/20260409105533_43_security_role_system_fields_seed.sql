/*
  # Seed System Fields for Security Role Entity

  ## Summary
  Adds system field definitions for the Security Role entity so fields
  are visible and manageable in the admin studio.

  ## Fields Added (all is_system = true, is_custom = false, is_deletable = false)
  - **Name** (text) - role name, required, searchable
  - **Description** (text) - role description
  - **Business Unit** (lookup -> business_unit) - owning business unit
  - **Is Active** (boolean) - active/inactive flag
  - **Is System** (boolean) - flags built-in system roles
...
DO $$
DECLARE
  v_entity_id   uuid := 'e3319109-c732-4191-809e-96cbdac1c5a6';
...
BEGIN
  ...
  INSERT INTO field_definition (
    ...
    (v_entity_id, v_lookup_type, v_bu_entity, 'business_unit_id','Business Unit', 'business_unit_id',false, false, true,  true,  false, true, false, false, true, 30),
    (v_entity_id, v_bool_type,   NULL,        'is_active',       'Is Active',     'is_active',       false, false, true,  true,  false, true, false, false, true, 40),
    (v_entity_id, v_bool_type,   NULL,        'is_system',       'Is System',     'is_system',       false, false, true,  true,  false, true, false, false, true, 50),
